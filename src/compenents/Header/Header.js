        ...
        <nav className="nav">
            <div className="nav-menu flex-row">
                <div className="nav-brand">
                    <a href="#" className="text-gray"><img src={logo}/></a>
                </div>
                <div className="middle">
                    <div>
                        <ul className="nav-items">
                            <li className="nav-link">
                                <a href="/" className="textlink" >Home</a>
                            </li>
                            <li className="nav-link">
                                <a href="/market" className="textlink">Market</a>
                            </li>
                            <li className="nav-link">
                            ...
                            <div className="wrapper">
                                ...
                                />
                                <input placeholder="Search items,collection,and accounts" type="text" className="search" />
